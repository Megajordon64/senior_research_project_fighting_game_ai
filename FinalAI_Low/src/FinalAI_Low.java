...
public class FinalAI_Low implements AIInterface{
  ...
  @Override
  public void close() {
    System.out.println("wins for low AI"+winCount);
    System.out.println("draws for low AI"+drawCount);
    System.out.println("losses for low AI"+lossCount);
  }
  ...
  public int initialize(GameData gameData, boolean playerNumber) {
    ...
    File file = new File("NN_setup1.txt");
   Scanner sc;
  try {
    sc = new Scanner(file);
