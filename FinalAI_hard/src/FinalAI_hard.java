...
public class FinalAI_hard implements AIInterface{
  ...
  @Override
  public void close() {
    System.out.println("wins for hard AI"+winCount);
    System.out.println("draws for hard AI"+drawCount);
    System.out.println("losses for hard AI"+lossCount);
  }
  ...
  public int initialize(GameData gameData, boolean playerNumber) {
    ...
    File file = new File("NN_setup3.txt");
   Scanner sc;
  try {
    sc = new Scanner(file);
